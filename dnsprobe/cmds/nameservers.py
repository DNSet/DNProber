...
from ..utils import update_databases


@add_command("update-databases", help="Update public DNS Servers database")
...
def run_cmd_update_databases(cmds: commands) -> int:
    ...
    for database in cmds.args.nameserver_databases:
        ...
        update_databases(config.nameservers_dir, db.database_name, db.url)
    return 0
